...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ki.sendText(msg.to,"มีข้อผิดพลาด")
                        kk.sendText(msg.to,"")
                        kc.sendText(msg.to,"")
                    else:
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "ความเร็ว บอท")
            ...
            elif msg.text in ["หัว"]:
                ki.sendText(msg.to, "siri:groupcreator")
            elif msg.text in ["ใครแอบ"]:
                ki.sendText(msg.to, "setlastpoint")
            elif msg.text in ["ออกมา"]:
                ki.sendText(msg.to, "viewlastseen")
            elif msg.text in ["เช็คคำสั่ง"]:
                ki.sendText(msg.to, "set:check")
...
#------------------------------------------------------------------
                ...
                if msg.from_ in admin:
                    ...
                    kk.sendText(msg.to,"")
                    kc.sendText(msg.to,"")
            elif msg.text in ["Banlist","เช็คริส"]:
                if msg.from_ in admin:
                    if wait["blacklist"] == {}:
            ...
            elif msg.text in ["Cek ban","เช็คแบน1"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"กลุ่มนี้ไม่มีราชื่อสีดำ")
                    ki.sendText(msg.to,"")
                    kk.sendText(msg.to,"")
                    kc.sendText(msg.to,"")
